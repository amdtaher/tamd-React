            ...
            <div className="grid grid-cols-12 grid-flow-row gap-5 px-5 md:px-0">
              ...
              <div className="col-span-12 md:col-span-4 capitalize">
                ...
                <div className="text-center">
                  ...
                  <p className='text-sm lg:text-base text-center text-secondary mt-2.5'>I deliver Dynamic and Responsive Websites from Scratch, with HTML, CSS & JavaScript...</p>
                </div>
              </div>
              {/* Single Service */}
              <div className="col-span-12 md:col-span-4 capitalize">
                ...
                <div className="text-center">
                  ...
                  <p className='text-sm lg:text-base text-center text-secondary mt-2.5'>Design is the main Beauty of a Site. Elevate your online presence with top-notch web design Using FIGMA...</p>
                </div>
              </div>
              {/* Single Service */}
              <div className="col-span-12 md:col-span-4 capitalize">
                ...
                <div className="text-center">
                  ...
                  <p className='text-sm lg:text-base text-center text-secondary mt-2.5'>I also provide hosting services, bringing your online vision to life and ensuring its smooth operation....</p>
                </div>
              </div>
            </div>
          </div>
