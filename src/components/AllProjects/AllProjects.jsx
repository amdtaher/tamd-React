      ...
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-12 grid-flow-row gap-5 px-5 sm:px-0">
          ...
          <div class="col-span-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-flow-row gap-5 text-center uppercase font-semibold">
              {/* Single Project */}
              <div class="group relative overflow-hidden">
                <img className='w-full rounded-md group-hover:scale-110 duration-300' src={projectImg1} alt="my-work"/>
                <span className='absolute top-2.5 left-2.5 capitalize font-medium rounded-xl bg-primary text-white py-0.5 px-4'>react</span>
                {/* Project Content */}
                <div className="hidden group-hover:flex flex-col justify-center items-center text-center text-white absolute inset-0 z-0 before:content-[''] before:bg-primary before:rounded-md before:opacity-70 before:absolute before:inset-0 before:z-[-1]">
                  <h4 className='text-xl'>Cherry Blossom</h4>
                  {/* Project Links */}
                  <div className="flex justify-center gap-5 mt-2.5">
                    <a href="#" className='hover:text-hover duration-200'><FaLink size={30}/></a>
                    <a href="#" className='hover:text-hover duration-200'><FaGithub size={30}/></a>
                  </div>
                </div>
              </div>
              {/* Single Project */}
              <div class="group relative overflow-hidden">
                ...
                <span className='absolute top-2.5 left-2.5 capitalize font-medium rounded-xl bg-primary text-white py-0.5 px-4'>react</span>
                {/* Project Content */}
                <div className="hidden group-hover:flex flex-col justify-center items-center text-center text-white absolute inset-0 before:content-[''] before:bg-primary before:rounded-md before:opacity-70 before:absolute before:inset-0 before:z-[-1] z-0 duration-300">
                  <h4 className='text-xl'>Cherry Blossom</h4>
                  {/* Project Links */}
                  <div className="flex justify-center gap-5 mt-2.5">
                    <a href="#" className='hover:text-hover duration-200'><FaLink size={30}/></a>
