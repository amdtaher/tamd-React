          ...
          <div className="col-span-12">
            <div className="grid grid-cols-12 grid-flow-row gap-5 capitalize">
              ...
              <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center gap-5">
                ...
                <p className='text-lg text-secondary my-6'>Prepared to make your ideas into reality? <br /> I'm here to help you bring your visions to life and achieve your goals.</p>
                {/* Contact Me button */}
                <div>
