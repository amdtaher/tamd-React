...
import { FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaPinterest, FaTwitter } from 'react-icons/fa'
      ...
      <div className='bg-black text-white'>
        <div className="container mx-auto py-16 md:py-20">
          <ul className="grid grid-cols-12 grid-flow-row gap-5 px-5 md:px-0">
              ...
              <li className="col-span-12 md:col-span-6 lg:col-span-3 flex justify-evenly items-center font-semibold mb-2.5 lg:mb-0">
                  ...
                  <a className='hover:scale-125 duration-200' href="https://www.instagram.com/the_dzsaymon_ofiicial/" target="_blank"><FaInstagram size={25}/></a>
                  <a className='hover:scale-125 duration-200' href="https://twitter.com/DzSpyder" target="_blank"><FaTwitter size={25}/></a>
                  <a className='hover:scale-125 duration-200' href="https://www.pinterest.com/taherahmed6927/" target="_blank"><FaPinterest size={25}/></a>
