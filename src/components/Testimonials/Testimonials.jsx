              ...
              <div className="col-span-12 lg:col-span-7 gap-5 text-center capitalize">
                <Slider {...settings}>
                  ...
                  <div className="rounded-lg mx-auto py-12 px-10">
                    ...
                    <p className='text-sm lg:text-base text-secondary font-normal text-center italic px-5 md:px-10'>Awesome template, well written code and looks great on any platform. The customer support is very helpful and as huge asset to this template. Overall a good design, that I am quite happy with.</p>
                  ...
                  <div className="rounded-lg mx-auto py-12 px-10">
                    <FaQuoteRight className='mx-auto mb-5' size={30}/>
                    <p className='text-sm text-secondary font-normal text-center italic'>Awesome template, well written code and looks great on any platform. The customer support is very helpful and as huge asset to this template. Overall a good design, that I am quite happy with.</p>
                      <div className="flex justify-center items-center gap-5 mt-5">
                          <img className='w-[60px] rounded-full' src={person1} alt="person"/>
                          <h4 className='text-base font-medium'>Gwen Stacy<span className='block'>UI/UX Designer</span></h4>
                      </div> 
