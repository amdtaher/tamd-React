      ...
      <div className="container mx-auto py-16 md:py-20">
        <div className="grid grid-cols-12 grid-flow-row gap-5 px-5 sm:px-0">
          ...
          <div className="col-span-12 uppercase pb-2.5 mb-2.5">
            <h4 className='relative font-black text-3xl md:text-4xl lg:text-5xl mb-2'>let's work (still in progress)
            ...
            <div className="grid grid-cols-12 grid-flow-row gap-5 md:gap-10">
              ...
              <div className="col-span-12 md:col-span-6 flex flex-col justify-center">
                <div className="flex flex-col gap-5">
                  <p className='text-base text-secondary'>Please fill out the form on this section to contact with me. Or call between 9:00 a.m. and 8:00 p.m. ET, Monday through Friday</p>
